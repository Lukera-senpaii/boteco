...
figlet -c -f slant -t 'Boteco' | lolcat 

echo  "Lukera no controle fml sem escândalo" | lolcat -a -d 50 
...
echo "[*] obrigado por utilizar o bot \"Boteco\" Lukera agradece ❤️"
echo $CYAN "Use npm start para iniciar o Boteco ✨"
